...
const items = [
  {
    icon: Newspaper,
    category: "お知らせ",
    title: "サービスサイトをリニューアルしました",
    date: "2025.01",
    image: "/images/news-1.jpg",
    description:
      "ATLASの公式サービスサイトを全面リニューアルいたしました。より分かりやすく、サービス内容や実績をご確認いただけるようになりました。",
    content: `この度、ATLASの公式サービスサイトを全面リニューアルいたしました。
...
お客様により良いサービスをお届けできるよう、今後もサイトの改善を続けてまいります。ご不明な点やご質問がございましたら、お気軽にお問い合わせください。`,
  },
  {
    icon: Award,
    category: "実績",
